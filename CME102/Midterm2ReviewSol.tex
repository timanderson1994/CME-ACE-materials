...
\documentclass[letterpaper, fontsize=10pt]{scrartcl} % A4 paper and 11pt font size
...
\fancyfoot[L]{\textit{CME 102 Winter '16-'17}} % Empty left footer
...
\begin{lstlisting}
function yp = derivative(x,y)
	A = [0, 0, 1, 0; 0, 0, 0, 1; -5, 4, 0, 0; 3, -3, 0, 0];
	yp = A*y;
end
